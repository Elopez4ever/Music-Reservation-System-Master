    ...
    <el-card class="filter-card" shadow="hover">
      ...
      <el-form :inline="true" :model="queryParams" class="filter-form">
        <el-form-item label="教学楼">
          <el-select v-model="queryParams.building" placeholder="全部" clearable>
            ...
            <el-option label="主教学楼" value="main"></el-option>
            <el-option label="科技楼" value="science"></el-option>
            <el-option label="图书馆" value="library"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="琴房类型">
          <el-select v-model="queryParams.roomTypeId" placeholder="全部" clearable>
        ...
        <el-form-item label="琴房号或者名称">
          <el-input 
            v-model="queryParams.roomNumberOrName" 
            placeholder="琴房号或者名称" 
            clearable
      ...
      <el-table
        ...
        <el-table-column
          ...
          width="180">
          <template slot-scope="scope">
            <div v-if="scope.row.facilities">
              <el-tag v-for="(facility, index) in getFacilitiesList(scope.row.facilities)" 
                :key="index" 
                size="mini" 
                class="facility-tag">
                {{ facility }}
