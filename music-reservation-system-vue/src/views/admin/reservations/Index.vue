    ...
    <el-card class="box-card" shadow="hover">
      ...
      <el-table
        ...
        <el-table-column
          ...
          min-width="160">
          <template slot-scope="scope">
            <div class="time-range compact-time">
              <el-tooltip placement="top" :content="formatDateTime(scope.row.startTime) + ' 至 ' + formatDateTime(scope.row.endTime)">
                <div>
...
.room-name, .username, .created-time {
  display: flex;
  align-items: center;
}

.room-name i, .username i, .created-time i {
  margin-right: 6px;
  color: #606266;
}
