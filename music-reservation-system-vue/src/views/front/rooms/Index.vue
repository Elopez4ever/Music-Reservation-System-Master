        ...
        <el-col :xs="24" :sm="24" :md="6">
          <el-card class="filter-card" shadow="hover">
            <div slot="header" class="card-header">
              <i class="el-icon-filter"></i> 筛选条件
            </div>
            <el-form   :model="filterForm" ref="filterForm" label-width="100px" size="small">
              <el-form-item label="教学楼">
                <el-select clearable v-model="filterForm.buildingId" placeholder="选择教学楼" style="width: 100%">
                  <el-option 
              ...
              <el-form-item label="所属院系">
                <el-select clearable v-model="filterForm.departmentId" placeholder="选择所属院系" style="width: 100%">
                  <el-option 
              ...
              <el-form-item label="琴房类型">
                <el-select clearable v-model="filterForm.roomTypeId" placeholder="选择琴房类型" style="width: 100%">
                  <el-option 
                    v-for="item in roomTypeOptions" 
                    :key="item.id" 
                    :label="item.typeName" 
                    :value="item.id">
                    <i :class="item.icon"></i> {{item.typeName}}
                  </el-option>
                </el-select>
              </el-form-item>
              
              <el-form-item label="容纳人数">
                <el-select clearable v-model="filterForm.capacity" placeholder="选择容纳人数" style="width: 100%">
                  <el-option 
              ...
              <!-- <el-form-item label="时间段">
                <el-select v-model="filterForm.timeRange" placeholder="选择时间段" style="width: 100%">
                  <el-option 
              ...
              <el-form-item>
                <el-button type="primary" icon="el-icon-search" @click="handleSearch" :loading="loading" class="search-btn">查询</el-button>
                  ...
                  <el-card class="room-card-item" shadow="hover" :body-style="{ padding: '0px' }">
                    ...
                    <div class="room-card-body">
                      ...
                      <div class="room-info-item">
                        ...
                        <span>琴房类型：{{formatRoomType(room.type)}}</span>
                      </div>
                      <div class="room-info-item">  
                        <i class="el-icon-office-building"></i>
                        <span>所属院系：{{room.departmentName}}</span>
                      </div>
                  
                      <div class="room-info-item">
                        <i class="el-icon-office-building"></i>
                        <span>建筑类型：{{room.buildingName}}</span>
                      </div>
                      <!-- <div class="room-info-item">
                        <i class="el-icon-time"></i>
                        <span>可用时间：{{formatAvailableTime(room.availableTimeSlots)}}</span>
                      </div> -->
                      <div class="room-facilities">
                        <el-tag 
                          v-for="(facility, fIndex) in room.facilities" 
                          :key="fIndex"
                          size="mini" 
                          type="info" 
                          effect="plain">
