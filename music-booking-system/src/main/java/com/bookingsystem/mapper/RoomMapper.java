...
public interface RoomMapper {
    ...
    @Update("update rooms set room_number = #{roomNumber}, name = #{name}, building_id = #{buildingId},department_id = #{departmentId} ,floor = #{floor}, status=#{status}, capacity = #{capacity}, room_type_id = #{roomTypeId}, facilities = #{facilities}, description = #{description}, updated_at = #{updatedAt} where id = #{id}")
